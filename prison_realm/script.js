                ...
                targetFaces.forEach(selector => {
                    ...
                    if (backgroundImgLayer) {
                        ...
                        if (selector === '#cubeFace1') {
                            backgroundImgLayer.style.backgroundImage = 'url(https://merveloushub.github.io/home/prison_realm/images/gojoCubeFace1_Animation.webp)';
                        } else if (selector === '#cubeFace4') {
                            backgroundImgLayer.style.backgroundImage = 'url(https://merveloushub.github.io/home/prison_realm/images/gojoCubeFace4_Animation.webp)';
                        } else if (selector === '#cubeFace5') {
                            backgroundImgLayer.style.backgroundImage = 'url(https://merveloushub.github.io/home/prison_realm/images/gojoCubeFace5_Animation.webp)';
                        }
